...
const TECHS = [
  // ── CORE ────────────────────────────────────────────────
  {
    ...
    tier: 'core',
    category: 'markup',
    description: 'HTML semântico, acessibilidade (ARIA, roles), SEO on-page, estrutura de documentos e boas práticas de markup.',
    since: '2022',
    proficiency: 85,
  ...
  },
  {
    ...
    tier: 'core',
    category: 'markup',
    description: 'Flexbox, Grid, Custom Properties, Media Queries, animações, responsividade e design mobile-first.',
    since: '2022',
    proficiency: 82,
  ...
  },
  {
    ...
    tier: 'core',
    category: 'scripting',
    description: 'ES6+ — arrow functions, destructuring, async/await, módulos, Promises e manipulação do DOM.',
    since: '2022',
    proficiency: 78,
  ...
  },
  {
    ...
    tier: 'core',
    category: 'framework',
    description: 'Componentes funcionais, hooks (useState, useEffect, useRef, useCallback), props, estado e Context API.',
    since: '2023',
    proficiency: 75,
  ...
  },
  {
    ...
    tier: 'core',
    category: 'tooling',
    description: 'Versionamento, branching strategies, pull requests, merge, rebase e colaboração em equipe.',
    since: '2023',
    proficiency: 72,
  ...
  },
  {
    ...
    tier: 'core',
    category: 'tooling',
    description: 'Repositórios, Issues, Pull Requests, GitHub Actions (básico) e fluxo de colaboração open source.',
    since: '2023',
    proficiency: 74,
  ...
  // ── LEARNING ────────────────────────────────────────────
  {
    ...
    tier: 'learning',
    category: 'scripting',
    description: 'Tipagem básica, interfaces, tipos utilitários (Partial, Required, Pick) e enums para codebases mais seguras.',
    since: '2024',
    proficiency: 45,
  ...
  },
  {
    ...
    tier: 'learning',
    category: 'framework',
    description: 'Roteamento com App Router, SSR, SSG, Server Components e deploy na Vercel.',
    since: '2024',
    proficiency: 40,
  ...
  },
  {
    ...
    tier: 'learning',
    category: 'framework',
    description: 'Utility-first CSS, tema customizado, variantes responsivas e integração com componentes React.',
    since: '2024',
    proficiency: 52,
  ...
  },
  {
    ...
    tier: 'learning',
    category: 'scripting',
    description: 'Consumo de APIs com fetch nativo, tratamento de erros, loading states e autenticação via headers.',
    since: '2024',
    proficiency: 48,
  ...
  },
  {
    ...
    tier: 'learning',
    category: 'scripting',
    description: 'Cliente HTTP com interceptors, transformações, cancelamento de requisições e integração com APIs REST.',
    since: '2024',
    proficiency: 42,
  ...
  },
  {
    ...
    tier: 'learning',
    category: 'tooling',
    description: 'Testes unitários com mocks, spies e assertions — estrutura básica de describe/it/expect.',
    since: '2025',
    proficiency: 30,
  ...
  },
  {
    ...
    tier: 'learning',
    category: 'tooling',
    description: 'Testes de componentes React focados no comportamento do usuário — queries por role, text e label.',
    since: '2025',
    proficiency: 28,
    Icon: ({ size, color }) => <SiTestinglibrary size={size} style={{ color }} />,
  },
  ...
  // ── TOOLS ───────────────────────────────────────────────
  {
    ...
    tier: 'tools',
    category: 'tooling',
    description: 'Editor principal — extensões, atalhos, integração Git e terminal integrado. Ambiente de desenvolvimento diário.',
    since: '2022',
    proficiency: 80,
  ...
  },
  {
    ...
    tier: 'tools',
    category: 'tooling',
    description: 'Pair programming assistido por IA — autocompletar, geração de funções e aceleração do fluxo de desenvolvimento.',
    since: '2024',
    proficiency: 72,
    Icon: ({ size, color }) => <SiGithubcopilot size={size} style={{ color }} />,
  },
  {
    id: 'claude',
    name: 'Claude (AI)',
    ...
    tier: 'tools',
    category: 'tooling',
    description: 'Assistência para revisão de código, debugging, documentação e aprendizado de novos conceitos e padrões.',
    since: '2024',
    proficiency: 78,
  ...
  },
  {
    ...
    tier: 'tools',
    category: 'design',
    description: 'Leitura e interpretação de layouts, design tokens, handoff para desenvolvimento e inspeção de componentes.',
    since: '2023',
    proficiency: 60,
  ...
  },
  {
    ...
    description: 'Sprints, planning, daily standups, retrospectivas e backlog grooming — metodologia ágil aplicada na prática.',
    since: '2023',
    proficiency: 52,
  ...
  },
  {
    ...
    tier: 'tools',
    category: 'methodology',
    description: 'Visualização do fluxo de trabalho com boards, WIP limits e otimização contínua de entregas.',
    since: '2023',
    proficiency: 55,
...
function OrbitNode({ tech, index, total, isSelected, isPaused, onSelect }) {
        ...
        >
          ...
          >
            ...
            <span
              ...
              style={{ boxShadow: `0 0 0 1px ${tech.brandColor}66, 0 0 16px ${tech.brandColor}33` }}
            />
            ...
            <span
              ...
              style={{
                ...
                filter: isSelected ? `drop-shadow(0 0 5px ${tech.brandColor}99)` : 'none',
              }}
            >
              <tech.Icon size={iconSize} color={isSelected ? tech.brandColor : `${tech.brandColor}bb`} />
            </span>
...
function DetailPanel({ tech, onClose }) {
  ...
  return (
    ...
    >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div>
              ...
              <p className="mt-0.5 text-xs" style={{ color: 'var(--color-neutral-400, #6b6c75)' }}>
                {CATEGORY_LABELS[tech.category]}{tech.since && ` · desde ${tech.since}`}
              </p>
            </div>
            <button
              onClick={onClose}
      ...
      {/* Description */}
      <p className="text-xs leading-relaxed" style={{ color: 'var(--color-neutral-300, #9a9ba6)' }}>
        {tech.description}
      </p>
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <p className="text-xs" style={{ color: 'var(--color-neutral-500, #3a3b42)' }}>
            Proficiência
          </p>
          <span className="text-xs font-semibold" style={{ color: tech.brandColor }}>
            {tech.proficiency}%
          </span>
        </div>
        <div
  ...
  return (
    ...
    >
      <motion.span
        ...
        style={{ background: 'rgba(79,53,214,0.12)', border: '1px solid rgba(79,53,214,0.28)' }}
        animate={{ scale: [1, 1.1, 1], opacity: [0.6, 1, 0.6] }}
        transition={{ duration: 2.8, repeat: Infinity, ease: 'easeInOut' }}
      >
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
          <circle cx="8" cy="8" r="2.5" fill="var(--color-accent-400, #7a62e8)" />
          <circle cx="8" cy="8" r="6" stroke="var(--color-accent-500, #4f35d6)" strokeWidth="1" strokeDasharray="2.5 2" fill="none" />
        </svg>
      </motion.span>
      <p className="text-xs font-medium" style={{ color: 'var(--color-neutral-400, #6b6c75)' }}>
        Clique em uma tecnologia
      </p>
      <p className="mt-0.5 text-xs" style={{ color: 'var(--color-neutral-600, #26272d)' }}>
...
function TechList({ techs, selected, onSelect }) {
  const byTier = { core: [], learning: [], tools: [] }
    ...
    >
      {Object.entries(byTier).map(([tier, items]) => {
        ...
        return (
          <div key={tier}>
            <div
              className="px-3 py-1.5 text-xs font-medium uppercase tracking-widest sticky top-0"
              style={{
                color: 'var(--color-neutral-500, #3a3b42)',
                background: 'rgb(13 14 16 / 0.96)',
                backdropFilter: 'blur(8px)',
                fontSize: '10px',
              }}
            >
            ...
            {items.map((tech) => {
              ...
              return (
                <button
                  ...
                  className="flex w-full items-center gap-2.5 px-3 py-1.5 text-left transition-all duration-100"
                  style={{
                    background: isActive ? `${tech.brandColor}10` : 'transparent',
                    borderLeft: isActive ? `2px solid ${tech.brandColor}` : '2px solid transparent',
                  }}
                >
                  <span style={{ color: isActive ? tech.brandColor : `${tech.brandColor}88`, flexShrink: 0 }}>
                    <tech.Icon size={13} color={isActive ? tech.brandColor : `${tech.brandColor}88`} />
                  </span>
                  <span
                    className="flex-1 text-xs font-medium truncate"
                    style={{
                      color: isActive ? 'var(--color-neutral-100, #e8e9ee)' : 'var(--color-neutral-300, #9a9ba6)',
                    }}
                  >
                    {tech.name}
                  </span>
                  <span className="text-xs tabular-nums" style={{ color: 'var(--color-neutral-600, #26272d)' }}>
                    {tech.proficiency}%
                  </span>
                </button>
              )
...
function StatsBar({ techs }) {
  ...
  const stats = [
    { label: 'total', value: total, color: 'var(--color-neutral-200, #c8c9d1)' },
    ...
    { label: 'média', value: `${avg}%`, color: 'var(--color-neutral-300, #9a9ba6)' },
  ]
...
function Legend({ filter, byTier, onFilter }) {
  const tiers = [
...
export function TechOrbit() {
  ...
  const handleSelect = useCallback((tech) => {
    setSelected(tech)
    setIsPaused(!!tech)
  }, [])
  ...
  const visibleTechs = filter === 'all' ? TECHS : TECHS.filter((t) => t.tier === filter)
  const byTier = (tier) => visibleTechs.filter((t) => t.tier === tier)
          ...
          {FILTERS.map((f) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive ? 'rgba(79, 53, 214, 0.18)' : 'rgb(255 255 255 / 0.04)',
                  color: isActive ? 'var(--color-accent-300, #a491f2)' : 'var(--color-neutral-400, #6b6c75)',
                  border: isActive
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_288px]">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            {/* Orbit rings */}
            {['core', 'learning', 'tools'].map((tier) => {
              const conf = TIER_CONFIG[tier]
              const hasTechs = byTier(tier).length > 0
              const isHighlighted = selectedTier === tier || (!selectedTier && filter === tier)
              const isActive = filter === 'all' || filter === tier
